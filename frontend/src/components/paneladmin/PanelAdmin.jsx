        ...
        {[
          ...
          <div key={label} style={{ marginBottom: 16 }}>
            ...
            <input type={type} value={val} onChange={(e) => set(e.target.value)} placeholder={placeholder} required
              style={{ width: "100%", padding: "11px 14px", background: "#1a1e25", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 8, color: "#e8eaf0", fontSize: 14, fontFamily: "'DM Sans', sans-serif", outline: "none" }}
